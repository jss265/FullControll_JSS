...
def set_up(user_overrides: dict):
    ''' Custom Ender 3 profile that respects user overrides for start/end code.
    '''
    ...
    # If user provided starting/ending steps, keep them. Otherwise build defaults.
    if 'starting_procedure_steps' in user_overrides:
        starting_procedure_steps = user_overrides['starting_procedure_steps']
    else:
    ...
    if 'ending_procedure_steps' in user_overrides:
        ending_procedure_steps = user_overrides['ending_procedure_steps']
    else:
